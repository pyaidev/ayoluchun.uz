...
class CourseAdmin(admin.ModelAdmin):
    list_display = ('title', 'author', 'price', 'is_discount', 'discount_price', 'language', 'is_finished')
    list_filter = ('title', 'author', 'price', 'is_discount', 'discount_price', 'is_finished')
    prepopulated_fields = {'slug': ('title',)}
    search_fields = ('title', 'author', 'price', 'is_discount', 'discount_price', 'is_finished')
