...
def certificaty(name, course):
    ...
    font_style = ImageFont.truetype("/home/nurmuhammad/uic/ayoluchun.uz/static/fonts/Roboto/Roboto-Regular.ttf", 50)
    ...
    cert_template.save("/home/nurmuhammad/uic/ayoluchun.uz/static/certicats/certificate.jpg")


certificaty(name="Nurmuhammad", course='Data science')